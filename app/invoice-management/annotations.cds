...
annotate service.Invoices with @(
    ...
    UI.Identification : [
        ...
        { Value : amount },
        { Value : status, Criticality : criticality },
        { $Type : 'UI.DataFieldForAction', Action : 'AdminService.SubmitInvoice', Label : 'Submit' },
    ...
    UI.Facets : [
        ...
        { $Type : 'UI.ReferenceFacet', Label : 'Invoice Items', Target : 'lineItems/@UI.LineItem' },
        { $Type : 'UI.ReferenceFacet', Label : 'Attachments', Target : 'attachments/@UI.LineItem' },
        { $Type : 'UI.ReferenceFacet', Label : 'Approval History', Target : 'approvalHistory/@UI.LineItem' }
    ]
